...
execute if score return kcdk.control matches 2 unless entity @s[nbt={Inventory:[{Count:1b,Slot:12b,id:"minecraft:black_stained_glass_pane"}]}] run function kcdk:plugin/igui/library/action/frame_1
execute if score return kcdk.control matches 2 unless entity @s[nbt={Inventory:[{Count:1b,Slot:21b,id:"minecraft:black_stained_glass_pane"}]}] run function kcdk:plugin/igui/library/action/frame_1
execute if score return kcdk.control matches 2 unless entity @s[nbt={Inventory:[{Count:1b,Slot:30b,id:"minecraft:black_stained_glass_pane"}]}] run function kcdk:plugin/igui/library/action/frame_1
execute if score return kcdk.control matches 2 unless entity @s[nbt={Inventory:[{Count:1b,Slot:16b,id:"minecraft:black_stained_glass_pane"}]}] run function kcdk:plugin/igui/library/action/frame_1
execute if score return kcdk.control matches 2 unless entity @s[nbt={Inventory:[{Count:1b,Slot:25b,id:"minecraft:black_stained_glass_pane"}]}] run function kcdk:plugin/igui/library/action/frame_1
execute if score return kcdk.control matches 2 unless entity @s[nbt={Inventory:[{Count:1b,Slot:34b,id:"minecraft:black_stained_glass_pane"}]}] run function kcdk:plugin/igui/library/action/frame_1

execute if score return kcdk.control matches 2 unless entity @s[nbt={Inventory:[{Count:1b,Slot:9b,id:"minecraft:command_block"}]}] run function kcdk:plugin/igui/page/file/fill_icon/item/09b_blue_chestplate
execute if score return kcdk.control matches 2 unless entity @s[nbt={Inventory:[{Count:1b,Slot:10b,id:"minecraft:command_block"}]}] run function kcdk:plugin/igui/page/file/fill_icon/item/10b_green_chestplate
...
execute if score return kcdk.control matches 2 unless entity @s[nbt={Inventory:[{Count:1b,Slot:15b,id:"minecraft:command_block"}]}] run function kcdk:plugin/igui/page/file/fill_icon/condition/15b_generals_death
execute if score return kcdk.control matches 2 unless entity @s[nbt={Inventory:[{Count:1b,Slot:22b,id:"minecraft:command_block"}]}] run function kcdk:plugin/igui/page/file/fill_icon/condition/22b_time_left
