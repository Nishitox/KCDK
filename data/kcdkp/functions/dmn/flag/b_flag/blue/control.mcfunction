execute unless score cap_b kcdkp.dmn matches 0 unless score cap_b kcdkp.dmn matches 1 run function kcdk:plugin/dmn/flag/b_flag/clear
execute if score cap_b kcdkp.dmn matches 0 if score blue_b kcdkp.dmn >= max_flag_progress kcdkp.dmn run function kcdk:plugin/dmn/flag/b_flag/blue/captured
