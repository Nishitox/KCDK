execute unless score cap_b kcdkp.dmn matches 0 unless score cap_b kcdkp.dmn matches 2 run function kcdk:plugin/dmn/flag/b_flag/clear
execute if score cap_b kcdkp.dmn matches 0 if score green_b kcdkp.dmn >= max_flag_progress kcdkp.dmn run function kcdk:plugin/dmn/flag/b_flag/green/captured
