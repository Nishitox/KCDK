execute unless score cap_b kcdkp.dmn matches 0 unless score cap_b kcdkp.dmn matches 4 run function kcdk:plugin/dmn/flag/b_flag/clear
execute if score cap_b kcdkp.dmn matches 0 if score yellow_b kcdkp.dmn >= max_flag_progress kcdkp.dmn run function kcdk:plugin/dmn/flag/b_flag/yellow/captured
