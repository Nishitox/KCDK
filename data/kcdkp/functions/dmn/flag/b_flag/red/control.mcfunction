execute unless score cap_b kcdkp.dmn matches 0 unless score cap_b kcdkp.dmn matches 3 run function kcdkp:dmn/flag/b_flag/clear
execute if score cap_b kcdkp.dmn matches 0 if score red_b kcdkp.dmn >= max_flag_progress kcdkp.dmn run function kcdkp:dmn/flag/b_flag/red/captured
