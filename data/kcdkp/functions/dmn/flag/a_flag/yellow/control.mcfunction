execute unless score cap_a kcdkp.dmn matches 0 unless score cap_a kcdkp.dmn matches 4 run function kcdk:plugin/dmn/flag/a_flag/clear
execute if score cap_a kcdkp.dmn matches 0 if score yellow_a kcdkp.dmn >= max_flag_progress kcdkp.dmn run function kcdk:plugin/dmn/flag/a_flag/yellow/captured
