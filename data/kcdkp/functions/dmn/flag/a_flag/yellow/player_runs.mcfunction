...
execute if score yellow_a kcdkp.dmn < max_flag_progress kcdkp.dmn if score blue_a kcdkp.dmn matches ..0 if score green_a kcdkp.dmn matches ..0 if score red_a kcdkp.dmn matches ..0 run scoreboard players add yellow_a kcdkp.dmn 1