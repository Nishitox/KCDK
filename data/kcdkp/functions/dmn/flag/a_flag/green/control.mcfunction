execute unless score cap_a kcdkp.dmn matches 0 unless score cap_a kcdkp.dmn matches 2 run function kcdkp:dmn/flag/a_flag/clear
execute if score cap_a kcdkp.dmn matches 0 if score green_a kcdkp.dmn >= max_flag_progress kcdkp.dmn run function kcdkp:dmn/flag/a_flag/green/captured
