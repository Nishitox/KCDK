execute unless score cap_a kcdkp.dmn matches 0 unless score cap_a kcdkp.dmn matches 3 run function kcdk:plugin/dmn/flag/a_flag/clear
execute if score cap_a kcdkp.dmn matches 0 if score red_a kcdkp.dmn >= max_flag_progress kcdkp.dmn run function kcdk:plugin/dmn/flag/a_flag/red/captured
