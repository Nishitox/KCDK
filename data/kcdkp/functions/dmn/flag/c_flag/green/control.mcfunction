execute unless score cap_c kcdkp.dmn matches 0 unless score cap_c kcdkp.dmn matches 2 run function kcdk:plugin/dmn/flag/c_flag/clear
execute if score cap_c kcdkp.dmn matches 0 if score green_c kcdkp.dmn >= max_flag_progress kcdkp.dmn run function kcdk:plugin/dmn/flag/c_flag/green/captured
