execute unless score cap_c kcdkp.dmn matches 0 unless score cap_c kcdkp.dmn matches 1 run function kcdkp:dmn/flag/c_flag/clear
execute if score cap_c kcdkp.dmn matches 0 if score blue_c kcdkp.dmn >= max_flag_progress kcdkp.dmn run function kcdkp:dmn/flag/c_flag/blue/captured
