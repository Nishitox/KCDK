...
execute unless entity @a[team=] run function kcdk:team/operation/team_assignment/team_assigned
execute if entity @a[team=] run function kcdk:team/operation/team_assignment/team_assignment