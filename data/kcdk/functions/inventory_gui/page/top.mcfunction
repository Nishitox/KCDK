 sexecute if entity @s[nbt={Inventory:[{Slot:9b}]}] run replaceitem entity @s inventory.0 minecraft:air
...
#execute if entity @s[nbt={Inventory:[{Slot:23b}]}] run replaceitem entity @s inventory.14 minecraft:air 23.team_operations
...
execute unless entity @s[nbt={Inventory:[{Count:1b,Slot:23b,id:"minecraft:leather_helmet",tag:{display:{Name:"{\"text\":\"チームの操作\"}"},HideFlags:2}}]}] run function kcdk:inventory_gui/click/open_team_operatioins
