...
function kcdk:general/default_settings/time
function kcdk:general/default_settings/weather
function kcdk:general/default_settings/worldborder
function kcdk:general/default_settings/worldspawn
