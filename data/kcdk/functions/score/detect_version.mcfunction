...
summon minecraft:item ~ ~ ~ {Item:{Count:1b,id:"minecraft:blue_ice",tag:{display:{Name:"{\"text\":\"kcdk.version.13\"}"}}}}
summon minecraft:item ~ ~ ~ {Item:{Count:1b,id:"minecraft:bamboo",tag:{display:{Name:"{\"text\":\"kcdk.version.14\"}"}}}}
summon minecraft:item ~ ~ ~ {Item:{Count:1b,id:"minecraft:beehive",tag:{display:{Name:"{\"text\":\"kcdk.version.15\"}"}}}}
summon minecraft:item ~ ~ ~ {Item:{Count:1b,id:"minecraft:basalt",tag:{display:{Name:"{\"text\":\"kcdk.version.16\"}"}}}}
