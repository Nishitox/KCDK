...
execute if entity @s[nbt={Inventory:[{Count:1b,Slot:35b,id:"minecraft:paper",tag:{display:{Name:"{\"text\":\"kcdkp.igui.file\"}"}}}]}] unless entity @s[nbt={Inventory:[{Count:1b,Slot:9b,id:"minecraft:bookshelf"}]}] run function kcdk:plugin/igui/page/file_item/open
execute if entity @s[nbt={Inventory:[{Count:1b,Slot:35b,id:"minecraft:paper",tag:{display:{Name:"{\"text\":\"kcdkp.igui.file\"}"}}}]}] unless entity @s[nbt={Inventory:[{Count:1b,Slot:10b,id:"minecraft:bookshelf"}]}] run function kcdk:plugin/igui/page/file_vc/open
execute if entity @s[nbt={Inventory:[{Count:1b,Slot:35b,id:"minecraft:paper",tag:{display:{Name:"{\"text\":\"kcdkp.igui.file\"}"}}}]}] unless entity @s[nbt={Inventory:[{Count:1b,Slot:26b,id:"minecraft:arrow"}]}] run function kcdk:plugin/igui/page/top/open