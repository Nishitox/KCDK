...
execute if entity @s[nbt={Inventory:[{Count:1b,Slot:35b,id:"minecraft:paper",tag:{display:{Name:"{\"text\":\"kcdkp.igui.team_op.1\"}"}}}]}] unless entity @s[nbt={Inventory:[{Count:1b,Slot:19b,id:"minecraft:blue_carpet"}]}] unless entity @s[nbt={Inventory:[{Count:1b,Slot:19b,id:"minecraft:blue_concrete"}]}] run function kcdk:plugin/igui/page/team_op_1/action/toggle_team/blue
execute if entity @s[nbt={Inventory:[{Count:1b,Slot:35b,id:"minecraft:paper",tag:{display:{Name:"{\"text\":\"kcdkp.igui.team_op.1\"}"}}}]}] unless entity @s[nbt={Inventory:[{Count:1b,Slot:20b,id:"minecraft:lime_carpet"}]}] unless entity @s[nbt={Inventory:[{Count:1b,Slot:20b,id:"minecraft:lime_concrete"}]}] run function kcdk:plugin/igui/page/team_op_1/action/toggle_team/green
execute if entity @s[nbt={Inventory:[{Count:1b,Slot:35b,id:"minecraft:paper",tag:{display:{Name:"{\"text\":\"kcdkp.igui.team_op.1\"}"}}}]}] unless entity @s[nbt={Inventory:[{Count:1b,Slot:21b,id:"minecraft:red_carpet"}]}] unless entity @s[nbt={Inventory:[{Count:1b,Slot:21b,id:"minecraft:red_concrete"}]}] run function kcdk:plugin/igui/page/team_op_1/action/toggle_team/red
execute if entity @s[nbt={Inventory:[{Count:1b,Slot:35b,id:"minecraft:paper",tag:{display:{Name:"{\"text\":\"kcdkp.igui.team_op.1\"}"}}}]}] unless entity @s[nbt={Inventory:[{Count:1b,Slot:22b,id:"minecraft:yellow_carpet"}]}] unless entity @s[nbt={Inventory:[{Count:1b,Slot:22b,id:"minecraft:yellow_concrete"}]}] run function kcdk:plugin/igui/page/team_op_1/action/toggle_team/yellow
execute if entity @s[nbt={Inventory:[{Count:1b,Slot:35b,id:"minecraft:paper",tag:{display:{Name:"{\"text\":\"kcdkp.igui.team_op.1\"}"}}}]}] unless entity @s[nbt={Inventory:[{Count:1b,Slot:24b,id:"minecraft:writable_book"}]}] run function kcdk:plugin/igui/page/team_op_2/open
execute if entity @s[nbt={Inventory:[{Count:1b,Slot:35b,id:"minecraft:paper",tag:{display:{Name:"{\"text\":\"kcdkp.igui.team_op.1\"}"}}}]}] unless entity @s[nbt={Inventory:[{Count:1b,Slot:26b,id:"minecraft:arrow"}]}] run function kcdk:plugin/igui/page/top/open