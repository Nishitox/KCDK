function kcdk:plugin/igui/score/return/enabled_team/blue
...
function kcdk:plugin/igui/score/return/enabled_team/green
...
function kcdk:plugin/igui/score/return/enabled_team/red
...
function kcdk:plugin/igui/score/return/enabled_team/yellow
