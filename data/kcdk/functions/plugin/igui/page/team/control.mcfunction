...
execute if score return kcdk.control matches 3 unless entity @s[nbt={Inventory:[{Count:1b,Slot:9b,id:"minecraft:writable_book"}]}] run function kcdk:plugin/igui/page/team/action/assign
execute if score return kcdk.control matches 3 unless entity @s[nbt={Inventory:[{Count:1b,Slot:24b,id:"minecraft:stone_pickaxe"}]}] run function kcdk:plugin/igui/page/team/action/create
execute if score return kcdk.control matches 3 unless entity @s[nbt={Inventory:[{Count:1b,Slot:18b,id:"minecraft:book"}]}] run function kcdk:plugin/igui/page/team/action/change
execute if score return kcdk.control matches 3 unless entity @s[nbt={Inventory:[{Count:1b,Slot:27b,id:"minecraft:paper"}]}] run function kcdk:plugin/igui/page/team/action/empty
