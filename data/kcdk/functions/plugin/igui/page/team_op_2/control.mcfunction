...
execute if entity @s[nbt={Inventory:[{Count:1b,Slot:35b,id:"minecraft:paper",tag:{display:{Name:"{\"text\":\"kcdkp.igui.team_op.2\"}"}}}]}] unless entity @s[nbt={Inventory:[{Count:1b,Slot:19b,id:"minecraft:lava_bucket"}]}] run function kcdk:plugin/igui/page/team_op_2/action/empty_teams
execute if entity @s[nbt={Inventory:[{Count:1b,Slot:35b,id:"minecraft:paper",tag:{display:{Name:"{\"text\":\"kcdkp.igui.team_op.2\"}"}}}]}] unless entity @s[nbt={Inventory:[{Count:1b,Slot:21b,id:"minecraft:fishing_rod"}]}] run function kcdk:plugin/igui/page/team_op_2/action/change_teams
execute if entity @s[nbt={Inventory:[{Count:1b,Slot:35b,id:"minecraft:paper",tag:{display:{Name:"{\"text\":\"kcdkp.igui.team_op.2\"}"}}}]}] unless entity @s[nbt={Inventory:[{Count:1b,Slot:23b,id:"minecraft:feather"}]}] run function kcdk:plugin/igui/page/team_op_2/action/team_assignment
execute if entity @s[nbt={Inventory:[{Count:1b,Slot:35b,id:"minecraft:paper",tag:{display:{Name:"{\"text\":\"kcdkp.igui.team_op.2\"}"}}}]}] unless entity @s[nbt={Inventory:[{Count:1b,Slot:26b,id:"minecraft:arrow"}]}] run function kcdk:plugin/igui/page/team_op_1/open