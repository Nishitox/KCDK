...
execute if entity @s[nbt={Inventory:[{Count:1b,Slot:35b,id:"minecraft:paper",tag:{display:{Name:"{\"text\":\"kcdkp.igui.file_item\"}"}}}]}] unless entity @s[nbt={Inventory:[{Count:1b,Slot:9b,id:"minecraft:command_block"}]}] run function kcdk:plugin/igui/page/file_item/action/refill/blue_leather_chestplate
execute if entity @s[nbt={Inventory:[{Count:1b,Slot:35b,id:"minecraft:paper",tag:{display:{Name:"{\"text\":\"kcdkp.igui.file_item\"}"}}}]}] unless entity @s[nbt={Inventory:[{Count:1b,Slot:10b,id:"minecraft:command_block"}]}] run function kcdk:plugin/igui/page/file_item/action/refill/green_leather_chestplate
execute if entity @s[nbt={Inventory:[{Count:1b,Slot:35b,id:"minecraft:paper",tag:{display:{Name:"{\"text\":\"kcdkp.igui.file_item\"}"}}}]}] unless entity @s[nbt={Inventory:[{Count:1b,Slot:11b,id:"minecraft:command_block"}]}] run function kcdk:plugin/igui/page/file_item/action/refill/red_leather_chestplate
execute if entity @s[nbt={Inventory:[{Count:1b,Slot:35b,id:"minecraft:paper",tag:{display:{Name:"{\"text\":\"kcdkp.igui.file_item\"}"}}}]}] unless entity @s[nbt={Inventory:[{Count:1b,Slot:12b,id:"minecraft:command_block"}]}] run function kcdk:plugin/igui/page/file_item/action/refill/yellow_leather_chestplate
execute if entity @s[nbt={Inventory:[{Count:1b,Slot:35b,id:"minecraft:paper",tag:{display:{Name:"{\"text\":\"kcdkp.igui.file_item\"}"}}}]}] unless entity @s[nbt={Inventory:[{Count:1b,Slot:13b,id:"minecraft:command_block"}]}] run function kcdk:plugin/igui/page/file_item/action/refill/wooden_pickaxe
execute if entity @s[nbt={Inventory:[{Count:1b,Slot:35b,id:"minecraft:paper",tag:{display:{Name:"{\"text\":\"kcdkp.igui.file_item\"}"}}}]}] unless entity @s[nbt={Inventory:[{Count:1b,Slot:26b,id:"minecraft:arrow"}]}] run function kcdk:plugin/igui/page/file/open