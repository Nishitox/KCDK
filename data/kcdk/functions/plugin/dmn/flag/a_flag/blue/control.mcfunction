execute unless score cap_a kcdkp.dmn matches 0 unless score cap_a kcdkp.dmn matches 1 run function kcdk:plugin/dmn/flag/a_flag/clear
execute if score cap_a kcdkp.dmn matches 0 if score blue_a kcdkp.dmn >= max_flag_progress kcdkp.dmn run function kcdk:plugin/dmn/flag/a_flag/blue/captured
