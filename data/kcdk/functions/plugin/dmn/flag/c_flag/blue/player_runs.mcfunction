...
execute if score blue_c kcdkp.dmn < max_flag_progress kcdkp.dmn if score green_c kcdkp.dmn matches ..0 if score red_c kcdkp.dmn matches ..0 if score yellow_c kcdkp.dmn matches ..0 run scoreboard players add blue_c kcdkp.dmn 1