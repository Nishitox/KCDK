...
execute if score yellow kcdkp.sv.ticket matches 0 run function kcdk:plugin/sv/ticket/message/out_of_ticket/yellow
execute if score yellow kcdkp.sv.ticket matches 0 run function kcdk:plugin/sv/ticket/out_of_ticket